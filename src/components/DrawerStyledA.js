...
const Drawer = (props) => {
  ...
  const items = [
    ...
    getItem(
      <Link href="/tabledisplayapi">Data Summary</Link>,
      "17",
      <TbDeviceDesktopAnalytics size={20} />
    ),
    ...
    getItem(
      ...
      null,
      [
        // getItem(<p>Fishing Vessels</p>, "g11", <GiFishingBoat size={20} />, [
        //   getItem(
        ...
        //   [
        //     getItem(
        //       <Link href="/activitymapsandtrends/merchantvesseltrends/playingthroughPAKEEZ">
        ...
        // getItem(<p>MSA Own Platform</p>, "g14", <GoGraph size={20} />, [
        //   getItem(
        ...
        getItem(<p>Activity Trends</p>, "g15", <SlGraph size={20} />, [
          ...
          getItem(
            <Link href="/activitymapsandtrends/merchantvesseltrends/activitytrends">
        ...
        getItem(<p>Duration At Sea</p>, "g18", <GiFishingBoat size={20} />, [
          getItem(
            <Link href="/activitymapsandtrends/fishingvessels/durationatsea">
