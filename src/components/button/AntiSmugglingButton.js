...
const AntiSmugglingButton = ({ onDataLoad }) => {
  // State variables
 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        "DATE", "YEAR", "LATITUDE", "LONGITUDE", "OWN SHIP/BOAT PARTICIPATED", "BOAT NAME", "COUNTRY", "CREW",
        "BOAT SAIL DATE", "INTEL DETAIL", "PRICE", "REMARKS"
      ];
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "ANTI SMUGGLING.csv") {
    ...
    try {
      ...
      formData.append('table', "Anti-Smuggling");
      formData.append('sheet', "ANTI SMUGGLING");
...
export default AntiSmugglingButton;
