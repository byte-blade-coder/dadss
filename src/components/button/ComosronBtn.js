 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        ...
        'TRANSIT THROUGH', 'DEPARTURE DATE', 'PC ISSUE DATE', 'PC ISSUE PLACE', 'TOTAL DAYS OF PC','POSITION',
        'PC DUE DATE', 'LEGAL/ILLEGAL', 'FISHING QTY', 'FISH TYPE', 'FISHING POSITION', 'GEARS',
        'TYPE OF CARGO', 'LATITUDE', 'LONGITUDE', 'TIME', 'MOBILE NO', 'REMARKS'
      ];
  ...
  const handleLoad = async () => {
    ...
    try {
      ...
      formData.append('table', "COMOSRON");
      formData.append('sheet', "COMOSRON");
