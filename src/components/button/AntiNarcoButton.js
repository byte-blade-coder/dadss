...
const AntiNarcoButton = ({ onDataLoad }) => {
  // State variables
 ...
 // console.log(cleanedCsvData);
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "ANTI NARCOTICS.csv") {
    ...
    try {
      ...
      formData.append('table', "Anti-Narco");
      formData.append('sheet', "ANTI NARCOTICS");
...
export default AntiNarcoButton;
