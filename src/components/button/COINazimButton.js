...
const COINazimButton = ({ onDataLoad }) => {
  // State variables
 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        ...
        // "PC Overdue",
        // "Reason",
        'REG NO', 'BOAT NAME', 'NAKWA NAME', 'OWNER NAME', 'OWNER CNIC', 'LATITUDE', 'LONGITUDE',
        'CREW', 'DEPARTURE DATE', 'PC EXPIRY DATE', 'PC OVERDUE', 'REASON'
      ];
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "COI DATA NAZIM.csv") {
    ...
    try {
     // debugger
      ...
      formData.append('table', "COI DATA NAZIM");
      formData.append('sheet', "COI DATA NAZIM");
