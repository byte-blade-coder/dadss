...
const COIDataShipButton = ({ onDataLoad }) => {
  console.log("onLoadData prop from COI_Btn: ", onDataLoad)
  // State variables
 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        ...
        // "Latitude",
        // "Longitude",
        'SOURCE', 'DATE', 'TIME', 'NO OF FVs', 'BOAT NAME', 'SFD-BFD', 'REG NO', 'NAKWA NAME',
        'OWNER NAME', 'COURSE', 'CREW', 'SPEED', 'NATIONALITY', 'LATITUDE', 'LONGITUDE'
      ];
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "COI DATA SHIPS.csv") {
    ...
    try {
     // debugger
      ...
      formData.append('table', "COI DATA SHIPS");
      formData.append('sheet', "COI DATA SHIPS");
...
export default COIDataShipButton;
