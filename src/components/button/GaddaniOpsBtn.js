...
const GaddaniOpsBtn = ({ onDataLoad, type }) => {
  // State variables
  console.log(type)
 ...
 // console.log(cleanedCsvData);
  ...
  const handleLoad = async () => {
    ...
    try {
      ...
      formData.append('table', "GADDANI SHIPS BOARDING OPS");
      formData.append('sheet', "GADDANI SHIPS BOARDING OPS");
