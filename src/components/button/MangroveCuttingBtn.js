...
const MangroveCuttingBtn = ({ onDataLoad }) => {
  // State variables
 ...
 // console.log(cleanedCsvData);
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "MANGROVES CUTTING.csv") {
    ...
    try {
      ...
      formData.append('table', "MANGROVES CUTTING");
      formData.append('sheet', "MANGROVES CUTTING");
...
export default MangroveCuttingBtn;
