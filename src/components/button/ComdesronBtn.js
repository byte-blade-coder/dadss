 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        'DATE', 'REG NO', 'BOAT NAME', 'BOAT TYPE', 'OWNER NAME', 'NAKWA NAME', 'CREW', 'DEPARTURE DATE',
        'PC ISSUE DATE', 'PC ISSUE PLACE', 'TOTAL DAYS OF PC', 'PC DUE DATE', 'LEGAL/ILLEGAL','POSITION',
        'FISHING QTY', 'FISH TYPE', 'FISHING POSITION', 'GEARS', 'TYPE OF CARGO', 'LATITUDE', 'LONGITUDE',
        'TIME', 'MOBILE NO', 'REMARKS', 'DEPARTURE JETTY/ OWNER', 'TRANS T CREEK'
      ];
  ...
  const handleLoad = async () => {
    ...
    try {
      ...
      formData.append('table', "COMDESRON");
      formData.append('sheet', "COMDESRON");
