...
const CodEndBtn = ({ onDataLoad }) => {
 ...
 // console.log(cleanedCsvData);
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (event) => {
      ...
      const requiredColumns = [
        'DATE', 'REG NO', 'BOAT NAME', 'OWNER NAME', 'QTY OF COD END'
      ];
  ...
  const handleLoad = async () => {
    ...
    if (file.name !== "COD END OBSERVED.csv") {
    ...
    try {
      ...
      formData.append('table', "COD END OBSERVED");
      formData.append('sheet', "COD END OBSERVED");
