        ...
        {!airCraftData ? (
          ...
          <>
            ...
            <div style={{ display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
                {/* Left side: Inputs */}
                <div style={{ display: "flex", margin: "20px 15px", width: "60%", visibility: currentMapView === "custom" ? "hidden" : "visible" }}>
                  <Input
                    placeholder="Enter Start Co-ordinates - Top Left (Lat, Lng)"
                    style={{ height: "fit-content", marginRight: "10px" }}
                    onChange={handleCoordSet1Input}
                ...
                <div style={{ margin: "20px 15px", display: "flex", justifyContent: "flex-end", width: "40%" }}>
                  <Radio defaultChecked onChange={() => handleMapViewChange("grid")} checked={currentMapView === "grid"} style={{ fontSize: 16 }}>
                    Grid View
                  </Radio>
                  <Radio onChange={() => handleMapViewChange("honeyComb")} checked={currentMapView === "honeyComb"} style={{ fontSize: 16 }}>
                    Honey-Comb View
                  </Radio>
                  <Radio onChange={() => handleMapViewChange("custom")} checked={currentMapView === "custom"} style={{ fontSize: 16 }}>
                    Custom View
                  </Radio>
                </div>
              </div>
            {currentMapView === "grid" ?
              ...
              : currentMapView === "honeyComb" ?
                ...
                : <Choropleth geoJSONData={geoJSONData}/>
            }
          </>}
      </div>
    </div>
